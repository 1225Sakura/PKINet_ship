...
project_dir = 'pkinet-s_dota_ship'
work_dir = f'./work_dirs/{project_dir}'

# DOTA船舶数据集只有1个类别: ship
num_classes = 1
bs = 2  # batch_size
num_workers = bs * 4
base_lr = 0.0002
...
checkpoint = 'checkpoints/pkinet_s_pretrain.pth'  # pretrain
# load_from = ''  # resume
...
# dataset settings
dataset_type = 'DOTAShipDataset'
data_root = 'data/dota_ship_only/'
img_norm_cfg = dict(
